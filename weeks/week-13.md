...
Тогда закон сохранения энергии имеет вид $`T_b+T_B=T_a+T_A+Q`$. При $`Q\gt 0`$ энергия покоя переходит в кинетическую; при $`Q\lt 0`$ реакция требует затрат энергии. Если мишень покоится, порог больше $`|Q|`$: часть энергии неизбежно остаётся в движении центра масс. В нерелятивистском приближении
