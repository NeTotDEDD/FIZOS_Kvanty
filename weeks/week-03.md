...
**Ответ:** $`\boxed{\Delta K\approx0.057\ \text{эВ},\quad D\gtrsim82\ \text{Å}.}`$ Оба числа совпадают с подробным решением в актуальном издании задачника; при $`\Delta\varphi=0.1^\circ`$ энергетический разброс равен примерно $`0.057`$ эВ.
