...
Обозначим $`s=\sigma_x^2>0`$. Условие минимума:
...
\frac{\epsilon_r-1}{\epsilon_r+1}>0,\qquad x>0.
```
...
```math
\psi_0(x)=\frac2{a^{3/2}}x e^{-x/a},\qquad x>0.
```
